...
contract OrderStore is IStructureInterface, IERC721Receiver {
    ...
    // function getOrderInfos(bool _bBuy, uint256 _fromIndex, uint256 _toIndex) view public returns(uint256[] memory orderIds, uint256[] memory amounts, uint256[] memory orderPrices) {
    ...
    //     amounts = new uint256[](_toIndex - _fromIndex);
    //     uint256 index = 0;
    ...
    //         amounts[index - _fromIndex] = _bBuy ? orderInfo.minOutAmount : orderInfo.inAmount;
